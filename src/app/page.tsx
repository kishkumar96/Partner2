...
export default function Home() {
  ...
  const [selectedCountry, setSelectedCountry] = useState<CountryCode | null>(
    urlState.country !== undefined ? urlState.country : 'VU'
  );
  ...
  const loadDamageLayer = useCallback(
    ...
    [damagedBuildings, damagedRoads, isLoadingDamage, selectedCountry]
  );
  ...
  const loadData = useCallback(async () => {
    ...
    if (!selectedCountry) {
      // Don't clear existing data - just skip loading
      // This prevents data from flashing when selectedCountry temporarily becomes null
      // during state updates or re-renders
