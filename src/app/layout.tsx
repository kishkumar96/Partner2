...
export const metadata: Metadata = {
  ...
  description: "Advanced WebGIS platform for real-time climate risk assessment and disaster impact analysis. Monitor cyclones, assess damages, and analyze regional impacts across the Pacific region.",
  keywords: [
    "climate risk",
    "disaster management",
    "GIS platform",
  ...
  openGraph: {
    ...
    description: "Advanced WebGIS platform for real-time climate risk assessment and disaster impact analysis.",
    images: [
      {
