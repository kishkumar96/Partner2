...
import { AlertTriangle, Calendar, ChevronDown, Database, Globe2, Keyboard, Target, Wind, Play, Pause, BookOpen, Zap, Check, Clock } from "lucide-react";
              ...
              >
                <div className="relative flex items-center justify-center">
                  ...
                  {filters.selectedHazards.includes(hazard.id) && (
                    <Check className="absolute w-3.5 h-3.5 text-blue-400 pointer-events-none animate-in zoom-in duration-200" strokeWidth={3} />
                  )}
                </div>
                <div
              ...
              >
                <div className="relative flex items-center justify-center">
                  ...
                  {filters.selectedSectors.includes(sector.id) && (
                    <Check className="absolute w-3.5 h-3.5 text-green-400 pointer-events-none animate-in zoom-in duration-200" strokeWidth={3} />
                  )}
                </div>
                <div
                  className="w-4 h-4 rounded-full flex-shrink-0 ring-2 ring-slate-700/50 shadow-lg group-hover:ring-slate-600 transition-all"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">
                    {storyMode ? "Story Mode" : isCyclonePlaying ? "Playing" : "Paused"}
                  </p>
                </div>
              </div>
              {!storyMode ? (
                ...
                <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-purple-500/20 text-purple-300 border border-purple-500/30">
