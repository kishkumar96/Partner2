      ...
      <div className="p-3 bg-green-50 dark:bg-green-900/20 rounded-lg border border-green-200 dark:border-green-800">
        <div className="flex items-start gap-2">
          ...
          <div className="text-xs text-green-800 dark:text-green-200">
            <strong>Field Validated:</strong> Damage assessments verified in 12
            communities (n=450 structures). Correlation coefficient r²=0.78 between
            modeled and observed damage.
          </div>
        </div>
      </div>
      ...
      <div className="p-3 bg-amber-50 dark:bg-amber-900/20 rounded-lg border border-amber-200 dark:border-amber-800">
        <div className="flex items-start gap-2">
          ...
          <div className="text-xs text-amber-800 dark:text-amber-200">
            <strong>Single Event Data:</strong> This dataset represents TC Lola
            (Feb 2024) only. Cannot predict future events or provide probabilistic
            risk analysis.
          </div>
        </div>
      </div>
